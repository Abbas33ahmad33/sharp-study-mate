                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <Card
                                    className="group relative overflow-hidden rounded-[2.5rem] border-none shadow-xl shadow-rose-500/10 bg-gradient-to-br from-rose-500 to-rose-600 text-white p-7 cursor-pointer transform transition-all active:scale-95 touch-none"
                                    onClick={() => navigate("/student/subjects")}
                                >
                                    <div className="absolute top-0 right-0 p-4 opacity-10 group-active:scale-110 transition-transform">
                                    ...
                                    <div className="relative z-10 space-y-4">
                                        ...
                                        <div>
                                            <h3 className="text-2xl font-black tracking-tight">Practice Subjects</h3>
                                            <p className="text-white/80 text-sm font-medium">Continue your learning journey with tailored MCQs.</p>
                                        </div>
                                ...
                                <Card
                                    className="group relative overflow-hidden rounded-[2.5rem] border-none shadow-xl shadow-slate-200/50 dark:shadow-black/20 bg-white dark:bg-slate-900 p-7 cursor-pointer transform transition-all active:scale-95 touch-none"
